...
class ex5GUI:
    ...
    def refresh_basket(self):
        ...
        self.create_basket_canvas()
        self.print_sum_baskets([0]*MAX_STORES, [0]*MAX_STORES
            , None)
    ...
    def get_prices_counts_best_GUI(self):
        ...
        for store_ix in range(MAX_STORES):
            try:
                ...
                print("error in get_basket_prices")
            if not self.basket_list[store_ix]:
                self.basket_list[store_ix] = [None]*len(self.basket)
    ...
    def print_sum_baskets(self,prices, counts, best_ix):
        for store_ix in range(MAX_STORES):
            if store_ix == best_ix:
                c = BEST_COLOR
            else:
    ...
    def print_basket(self):
        ...
        self.print_sum_baskets(prices, counts, best_ix)
